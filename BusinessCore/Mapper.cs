    ...
    public static class Mapper
    {
        static Mapper()
        {
            var config = new MapperConfiguration(cfg =>
            {
                ...
                cfg.CreateMap<DataCore.Calendar, Calendar>()
                ...
                //cfg.CreateMap<AllData, BusinessCore.Models.Event>()
                ...
                cfg.CreateMap<Event, DataCore.Event>()
                    .ConstructUsing(val => new DataCore.Event()
                    {
                        Id = val.Id,
                        AllDay = val.IsAllDay,
