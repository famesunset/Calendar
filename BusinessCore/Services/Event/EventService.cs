namespace BusinessCore.Services.Event
{
    ...
    public class EventService : IEventService
    {
        public int AddEvent(string session, int calendarId, Event @event)
        {
            ...
            DataCore.Event dataEvent = Map.Map<Event, DataCore.Event>(@event);
        ...
        public Event GetEvent(string session, int id)
        {
            ...
            var businessEvent = Map.Map<DataCore.Models.AllData, Event>(dataEvent);
        ...
        public IEnumerable<Calendar> GetEvents(string session, DateTime beginning, DateUnit dateUnit)
        {
            ...
            {
                bUserCalendars.Add(Map.Map<DataCore.Calendar, Calendar>(cal));
            }
            ...
            foreach (var allData in events)
            {
                ...
                var bEvent = Map.Map<DataCore.Models.AllData, BaseEvent>(allData);
        ...
        public void CreateScheduledEvent(Event @event)
        {
            ...
            DataCore.Event dataEvent = Mapper.Map.Map<Event, DataCore.Event>(@event);
